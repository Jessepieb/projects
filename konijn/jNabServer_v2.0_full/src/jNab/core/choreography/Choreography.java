...
public class Choreography
{
    ...
    /**
     * Choreography library where the choreography is stored.
     */
    ...
    /**
     * Setting the choreography library where the choreography is stored.
     * 
     * @param choreographyLibrary the choreography library where the choreography is stored.
     */
    public void setChoreographyLibrary(ChoreographyLibrary choreographyLibrary)
    {
	this.choreographyLibrary = choreographyLibrary;
    }

    /**
     * Getting the choreography library where the choreography is stored.
     * 
     * @return the choreography library where the choreography is stored or <tt>null</tt> if the choreography is not part of any library
     */
    public ChoreographyLibrary getChoreographyLibrary()
    {
